...
//! // the version of the `ink_metadata` crate used by the contract
//! let metadata_version = Version::new(3, 0, 0);
//!
//! let metadata = ContractMetadata::new(metadata_version, source, contract, Some(user), abi_json);
//!
//! // serialize to json
