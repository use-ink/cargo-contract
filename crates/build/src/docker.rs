...
fn update_build_result(host_folder: &Path, build_result: &mut BuildResult) -> Result<()> {
    ...
    // TODO: Clippy currently throws a false-positive here. The manual allow can be removed
    // after https://github.com/rust-lang/rust-clippy/pull/13609 has been released.
